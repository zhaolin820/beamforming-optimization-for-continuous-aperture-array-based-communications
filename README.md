...
The code for the paper **Z. Wang, C. Ouyang, and Y. Liu, “Beamforming Optimization for Continuous Aperture Array (CAPA)-based Communications,” *IEEE Trans. Wireless Commun.*, Early Access, Mar, 2025.** [[IEEE](https://ieeexplore.ieee.org/document/10910020)] [[Arxiv](https://arxiv.org/abs/2410.13677)]
