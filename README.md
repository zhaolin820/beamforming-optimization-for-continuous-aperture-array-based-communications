...
<img decoding="async" src="./img/system_model.jpg" width="80%">
...
Run `Figure_5.m` for plotting Fig. 5 in this paper.

### Expected Results

#### Weighted sum-rate versus aperture size
<img decoding="async" src="./img/rate_vs_aperture.jpg" width="80%">
